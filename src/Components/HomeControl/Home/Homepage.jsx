    ...
    return (
        <div className="container-fluid m-0 p-0 h-100">
            ...
            <div className="border-bottom py-2">
                <div className="d-flex m-0 p-0 align-items-center gap-2 ms-auto  py-2 px-3" style={{ width: 'fit-content' }}>
                    <img src={sample} alt="" className="" style={{ width: '35px', height: "35px" }} />
                    <div className="m-0 p-0">
                        <p className="m-0 p-0" style={{ fontSize: 14 }}>{userDetails.userName}</p>
                        <p className="m-0 p-0" style={{ fontSize: 12 }}>{userDetails.mailId}</p>
                    </div>
                </div>
            </div>
                ...
                <div className="col-12 d-flex flex-wrap m-0 p-0">
                    {
                        quatationlist.map((value, key) => (
                            <div key={key} className="m-2 p-3 border col-6 rounded-2" onClick={() => handleNavigate(value.id)}>
                                <div className="d-flex align-items-center gap-3">
                                    <h6>Start date : {value.StartDate}</h6>
                                    <h6>End date : {value.EndDate}</h6>
                                    <h6>Package type  : {value.packagetype}</h6>
                                </div>
                            </div>
                        ))
                    }
